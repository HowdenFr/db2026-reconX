...
(function () {
  ...
  table.querySelectorAll('.resize-handle').forEach(function (handle) {
    handle.addEventListener('mousedown', function (e) {
      ...
      function onMove(ev) {
        ...
        if (newWidth > 60) th.style.width = newWidth + 'px'; // enforce 60px minimum
      }
      function onUp() {
  ...
  // PagedResponse wraps items in a "content" array (see PagedResponse.java).
  ...
  fetch('/api/v1/trades?size=200')
    ...
    .catch(function () {
      ...
      rows = [
        { tradeRef: 'EQU-20260603-0001', instrumentSymbol: 'SAP.DE', quantity: 1000, price: 125.50, status: 'MATCHED', tradeDate: '2026-06-03' },
        { tradeRef: 'FX-20260603-0001', instrumentSymbol: 'EUR/USD', quantity: 1000000, price: 1.0852, status: 'PENDING', tradeDate: '2026-06-03' },
        { tradeRef: 'EQU-20260603-0002', instrumentSymbol: 'AAPL', quantity: 500, price: 178.20, status: 'BREAK', tradeDate: '2026-06-03' },
        { tradeRef: 'EQU-20260604-0001', instrumentSymbol: 'MSFT', quantity: 750, price: 320.10, status: 'MATCHED', tradeDate: '2026-06-04' },
        { tradeRef: 'EQU-20260604-0002', instrumentSymbol: 'AMZN', quantity: 200, price: 185.50, status: 'UNMATCHED', tradeDate: '2026-06-04' },
        { tradeRef: 'EQU-20260605-0001', instrumentSymbol: 'TSLA', quantity: 300, price: 245.80, status: 'MATCHED', tradeDate: '2026-06-05' },
      ];
      renderRows();
    });
})();
