 ...
 * HOW:     Registers Spring beans that configure Swagger/OpenAPI.
 * WHY:     Swagger UI becomes the central documentation for developers,
 *          frontend teams, QA, and external consumers.
 * ============================================================================
 */
@Configuration
public class OpenApiConfig {
    //Bean Object Apart of Our Configuration |  Manages Our API For US 
    @Bean
    ...
    //bean for public API( Finds Public)
    @Bean
    ...
    //bean for Admin APi( Finds Admin) 
    @Bean
